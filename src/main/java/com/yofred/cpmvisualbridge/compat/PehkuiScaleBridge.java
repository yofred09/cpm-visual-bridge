...
public final class PehkuiScaleBridge {
    ...
    private static synchronized void initialize() {
        ...
        try {
            ...
            CpmVisualBridge.LOGGER.warn("Could not initialize optional Pehkui scale bridge", error);
        }
    }
    ...
    private static float invoke(Method method, Entity entity, float partialTick) {
        ...
        try {
            ...
            available = false;
            CpmVisualBridge.LOGGER.warn("Disabling Pehkui scale bridge after a render failure", error);
            return 1.0F;
        }
    }
}
